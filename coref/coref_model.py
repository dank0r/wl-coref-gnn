...
class CorefModel:  # pylint: disable=too-many-instance-attributes
    ...
    def run(self,  # pylint: disable=too-many-locals
        ...
        for i in range(0, len(words), batch_size):
            ...
            # a_scores_batch = self.a_scorer(words, current_batch_number, nominal_batch_size)
            a_scores_batch = self.a_scorer(
                ...
                current_i=i, nominal_batch_size=batch_size
            )
    ...
    def train(self):
        ...
        for epoch in range(self.epochs_trained, self.config.train_epochs):
            ...
            for doc_id in pbar:
                ...
                # scaler.scale(c_loss).backward(retain_graph=True)
                ...
                # print(s_loss.grad_fn)
                (c_loss + s_loss).backward()
                # scaler.scale(c_loss + s_loss).backward()
